            ...
            <div className="flex gap-3.5 items-center">
              {[
                ...
                },
                {
                  ...
                  label: 'github',
                  url: 'https://github.com/daypoo' // TODO: 실제 GitHub 조직/계정 주소로 변경
                }
              ].map((sns, i) => (
                <a
                  key={i}
