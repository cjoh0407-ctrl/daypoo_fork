          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-10 text-left">
            ...
            >
              <WaveButton
                onClick={onCtaClick}
                variant="primary"
                className="px-5 py-3 sm:px-7 sm:py-3.5 text-[13px] sm:text-[15px] font-semibold"
              >
                가까운 화장실 찾기
              </WaveButton>
              <WaveButton
            ...
            >
              <div className="grid grid-cols-2 gap-3">
                <div className="p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/10 text-center space-y-1.5">
                  <div className="text-emerald-400 text-xl font-bold tabular-nums">
                    {stats.todayReports.toLocaleString()}
                  </div>
                  <div className="text-[11px] text-emerald-300/60 font-medium uppercase tracking-wider">
                    오늘의 리포트
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center text-xs">
                  <span className="text-slate-400 font-medium flex items-center gap-2">
                    <Activity size={12} /> 실시간 데이터 분석 엔진
                  </span>
                  ...
                  {FLOW_LANES.map((y, i) => (
                    <div
                      ...
                      style={{
                        top: `${y}%`,
                        background:
                          'linear-gradient(to right, transparent 3%, rgba(52,211,153,0.12) 15%, rgba(52,211,153,0.12) 85%, transparent 97%)',
                      }}
                    />
                  ))}
                  ...
                  <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
                    ...
                    >
                      <m.div
                        ...
                        style={{
                          boxShadow: '0 0 10px rgba(52,211,153,0.7), 0 0 20px rgba(52,211,153,0.3)',
                        }}
                      />
                    </m.div>
                  </div>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-[11px] text-slate-500 truncate">
                    {toiletsLoading
                      ? '갱신 중...'
                      : `현재 가장 깨끗한 화장실 ${toilets.length}곳 발견`}
                  </div>
                </div>
                <TrendingUp
                  size={20}
      ...
      */}
      ...
      >
        <div className="max-w-5xl mx-auto mb-12">
          ...
          >
            <p className="text-xs font-semibold uppercase tracking-wider mb-3 text-emerald-600">
              HOW IT WORKS
            </p>
